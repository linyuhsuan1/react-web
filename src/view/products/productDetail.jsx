        ...
        <section className="overflow-hidden text-gray-600 body-font">
            <div className="container px-5 pb-24 mx-auto">
                ...
                <div className="w-full mt-6 lg:w-1/2 lg:pl-10 lg:py-6 lg:mt-0">
                    ...
                    <button className="flex px-6 py-2 ml-auto text-white bg-indigo-500 border-0 rounded focus:outline-none hover:bg-indigo-600"  onClick={addCart}>Button</button>
                    </div>
                </div>
                </div>
            </div>
