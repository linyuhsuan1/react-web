...
const getCityOptions = (cities) => {
    return cities.map((city) => {
        return (
            <option key={city} data-value={city} value={city}>{city}</option>
        )
    })
}
...
const getDistricOptions = (districts) => {
    return districts.map((district) => {
        return (
            <option key={district} data-value={district} value={district}>{district}</option>
        )
    })
}
...
const AddressPicker = ({
    ...
    useEffect(() => {
        // console.log('ffffffffff', div.current)
        // let enhanced_selects = div.current.querySelectorAll("input[name='enhanced_selects']")
        // console.log('jjjj', enhanced_selects)
    ...
    return (
        <>
            <div className="flex flex-wrap mb-2 -mx-3" ref={div}>
                <div className="w-full px-3 mb-6 md:w-1/3 md:mb-0">
                    ...
                    <input type="hidden" name='enhanced_selects' name="city" value={city} />
                </div>
                <div className="w-full px-3 mb-6 md:w-1/3 md:mb-0">
                    <label className="block mb-2 text-xs font-bold tracking-wide text-gray-700 uppercase" >
                        State
                    ...
                    <div className="relative">
                        ...
                        <input type="hidden" name='enhanced_selects' name="district" value={district} />
